...
| # | 작업 | 원본 | 상태 |
|---|------|------|------|
| 28 | GraphCanvas3D 컴포넌트 분해 (렌더링 로직 분리) | 04,11,16 | [x] |
| 29 | InstancedMesh 적용 PoC (노드 수 증가 대비) | 08,16 | [x] |
| 31 | deep/03 LOC 리팩토링 일괄 실행 (공유 상수 추출, 함수 통합, ref 정리 등 ~20건) | deep/03 | [x] |
