...
| # | 작업 | Phase | 크기 |
|---|------|-------|------|
| 5-1 | 루트 레이아웃 최종 정리 | 5 핵심 UI 컴포넌트 | S |
| 5-2 | 그래프 컴포넌트 (react-force-graph-2d) | 5 핵심 UI 컴포넌트 | L |
| 5-3 | 분할 뷰 레이아웃 | 5 핵심 UI 컴포넌트 | M |
| 5-4 | 노드 상세 패널 (MDX 본문) | 5 핵심 UI 컴포넌트 | M |
| 5-5 | 메인 페이지 조립 (?node=slug) | 5 핵심 UI 컴포넌트 | M |
