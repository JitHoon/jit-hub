...
Phase 8 진행 중 — **8-1, 8-2, 8-3, 8-4, 8-5-1, 8-5-2, 8-5-3, 8-5-4, 8-6, 8-7-1, 8-7-2, 8-8-1, 8-8-2, 8-9, 8-10, 8-11, 8-12-1, 8-12-2 완료** → 다음: 8-13 통합 빌드 검증
...
| 8-9 | 구현: 콘텐츠 전환 처리 -- 다른 노드 클릭 시 opacity 크로스페이드 + 본문 상단 스크롤 | S | 8-8-2 | [x] |
| 8-10 | 구현: `src/components/ScrollToTopButton.tsx` 생성 -- fixed bottom-8 right-8 FAB, 콘텐츠 영역이 뷰포트에 보일 때(IntersectionObserver) fade-in+scale 등장 (200ms), 클릭 시 window.scrollTo top:0 | S | 8-8-2 | [x] |
